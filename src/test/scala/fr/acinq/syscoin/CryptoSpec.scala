...
class CryptoSpec extends FlatSpec {
  ...
  "Crypto" should "import private keys" in {
    // exported from the syscoin client running in testnet mode
  ...
  // see https://en.syscoin.it/wiki/Technical_background_of_Syscoin_addresses
  ...
  it should "generate deterministic signatures" in {
    // dataset from https://syscointalk.org/index.php?topic=285142.msg3299061#msg3299061
    val dataset = Seq(
      (
