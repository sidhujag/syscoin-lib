...
class TransactionSpec extends FlatSpec with Matchers {
  "Syscoins library" should "create and sign transaction" in {
  ...
  it should "read and write transactions" in {
    ...
    assert(Transaction.write(tx) === hex)
  }
  it should "create and verify pay2pk transactions with 1 input/1 output" in {
    ...
    // step #5: now we replace the sigscript with sig + public key, and we get what would be sent to the sys network
  ...
  it should "create and verify sign pay2pk transactions with multiple inputs and outputs" in {
    ...
    assert(Transaction.write(tx1) === BinaryData(""))
  ...
  it should "create and sign p2sh transactions" in {
    ...
    val tx = Transaction(
      ...
      txOut = TxOut(
        amount = 900000 satoshi, // 0.009 SYS in satoshi, meaning the fee will be 0.01-0.009 = 0.001
  ...
  it should "sign a 3-to-2 transaction with helper method" in {
    ...
    // 0.03 and 0.07 SYS in satoshi, meaning the fee will be (0.01+0.002+0.09)-(0.03+0.07) = 0.002
    ...
    assert(Transaction.write(signedTx) == BinaryData(""))
