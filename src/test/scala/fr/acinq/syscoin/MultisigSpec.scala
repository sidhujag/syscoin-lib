...
import fr.acinq.syscoin
import fr.acinq.syscoin.Crypto.{PrivateKey, Scalar}
...
class MultisigSpec extends FlatSpec with Matchers {
  ...
  "Syscoins library" should "create and sign multisig transactions" in {

    // tested with syscoin core client using command: createmultisig 2 "[\"0394D30868076AB1EA7736ED3BDBEC99497A6AD30B25AFD709CDF3804CD389996A\",\"032C58BC9615A6FF24E9132CEF33F1EF373D97DC6DA7933755BC8BB86DBEE9F55C\",\"02C4D72D99CA5AD12C17C9CFE043DC4E777075E8835AF96F46D8E3CCD929FE1926\"]"
    ...
    assert(Transaction.write(signedTx) == BinaryData(""))
  ...
  it should "spend multisig transaction" in {
    ...
    // 0.008 SYS in satoshi, meaning the fee will be 0.009-0.008 = 0.001
    ...
    //this works because signature is not randomized
    assert(Transaction.write(signedTx) == BinaryData(""))
