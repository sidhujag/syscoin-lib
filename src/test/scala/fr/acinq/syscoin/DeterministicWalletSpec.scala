...
class DeterministicWalletSpec extends FlatSpec {
  ...
  // these tests are the "official" ones (see https://github.com/syscoin/bips/blob/master/bip-0032.mediawiki)
  ...
  "Determinstic Wallet" should "generate and derive keys (test vector #1)" in {
    ...
    assert(encode(derivePrivateKey(m, hardened(0) :: 1L :: hardened(2) :: 2L :: 1000000000L :: Nil), testnet = false) === "xprvA41z7zogVVwxVSgdKUHDy1SKmdb533PjDz7J6N6mV6uS3ze1ai8FHa8kmHScGpWmj4WggLyQjgPie1rFSruoUihUZREPSL39UNdE3BBDu76")
  }
