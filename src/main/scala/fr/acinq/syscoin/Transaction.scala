...
import fr.acinq.syscoin.Script.Runner
import Protocol._
import fr.acinq.syscoin.Crypto.PrivateKey

import scala.collection.mutable.ArrayBuffer

object OutPoint extends SysMessage[OutPoint] {
...
object TxIn extends SysMessage[TxIn] {
...
object TxOut extends SysMessage[TxOut] {
...
object ScriptWitness extends SysMessage[ScriptWitness] {
...
object Transaction extends SysMessage[Transaction] {
