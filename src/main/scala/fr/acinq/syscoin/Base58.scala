...
/*
 * see https://en.syscoin.it/wiki/Base58Check_encoding
 *
...
/**
  * https://en.syscoin.it/wiki/Base58Check_encoding
  * Base58Check is a format based on Base58 and used a lot in syscoin, for encoding addresses and private keys for
