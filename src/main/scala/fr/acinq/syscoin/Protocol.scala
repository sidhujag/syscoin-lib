...
object Protocol {
  ...
  def readCollection[T](input: InputStream, maxElement: Option[Int], protocolVersion: Long)(implicit ser: SysMessage[T]): Seq[T] =
    readCollection(input, ser.read, maxElement, protocolVersion)

  def readCollection[T](input: InputStream, protocolVersion: Long)(implicit ser: SysMessage[T]): Seq[T] =
  ...
  def writeCollection[T](seq: Seq[T], out: OutputStream, protocolVersion: Long)(implicit ser: SysMessage[T]): Unit = {
...
object BlockHeader extends SysMessage[BlockHeader] {
...
/**
  * see https://en.syscoin.it/wiki/Protocol_specification#Merkle_Trees
  */
object MerkleTree {
...
object Block extends SysMessage[Block] {
    ...
    Block(
      ...
      List(
        Transaction(version = 1,
          ...
          txOut = List(TxOut(amount = 50 sys, publicKeyScript = scriptPubKey)),
          lockTime = 0))
    )
  }
...
object Message extends SysMessage[Message] {
...
/**
  * Syscoin message exchanged by nodes over the network
  *
...
object NetworkAddressWithTimestamp extends SysMessage[NetworkAddressWithTimestamp] {
...
object NetworkAddress extends SysMessage[NetworkAddress] {
...
object Version extends SysMessage[Version] {
...
object Addr extends SysMessage[Addr] {
...
object InventoryVector extends SysMessage[InventoryVector] {
  val ERROR = 0L
  val MSG_TX = 1L
  val MSG_BLOCK = 2L
...
object Inventory extends SysMessage[Inventory] {
...
object Getheaders extends SysMessage[Getheaders] {
...
object Headers extends SysMessage[Headers] {
...
object Getblocks extends SysMessage[Getblocks] {
...
object Getdata extends SysMessage[Getdata] {
...
object Reject extends SysMessage[Reject] {
